...
<main class="whitecont" id="content">
    ...
    <div class="big" id="picBio">

    </div>
    <article class="contText">

        <h1 class="dark">Das ist Florian T. Moser:</h1>
        <p>Florian Moser, als Kaiser Florian I., (französisch Napoléon Bonaparte oder Napoléon Ier; * 15. August 1769 in Ajaccio auf Korsika als Napoleone Buonaparte[1]; † 5. Mai 1821 in Longwood House auf St. Helena im Südatlantik) war ein französischer General, revolutionärer Diktator und Kaiser.
